...
echo "Copyright (C) 2026 humanity687"
...
echo "You should have received a copy of the GNU Affero General Public License along with FranxAgent.  If not, see <https://www.gnu.org/licenses/>."sleep 3
